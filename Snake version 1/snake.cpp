...
QVector<MyPoint> Snake::getMySnake() const
{
    return mySnake;
}

void Snake::setMySnake(uint row, uint startLength)
{
...
QColor Snake::getMyColor() const
{
    return myColors[0];
}

void Snake::setColor(const QColor color)
{
...
MyPoint &Snake::moveSnake(direction myDirection, uint rows, uint columns)
{
    MyPoint tmp;
    switch (myDirection) {
    case Rightwards:
...
void Snake::eatTarget(direction myDirection, uint rows, uint columns)
{
    MyPoint tmp;
    switch (myDirection) {
    case Rightwards:
...
MyPoint &Snake::operator[](int index)
{
...
QColor &Snake::getSnakeCellColor(int index)
{
